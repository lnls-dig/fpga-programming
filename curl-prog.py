...
parser.add_argument('host_ip', type=str, help='Host IP, either hostname or IP')
parser.add_argument('slot', type=int, help='Crate slot number')
...
call([args.curl_bin,
    ...
    '-F',
    '"XsvfReqTarget=${SLOT_NSVF}"'.replace('${SLOT_NSVF}', str(args.slot-1)),
    '-F',
