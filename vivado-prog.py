...
parser.add_argument('--vivado', type=str, help='Vivado binary path', default='vivado')
parser.add_argument('--hw_server', type=str, help='HW Server binary path', default='hw_server')
